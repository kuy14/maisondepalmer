                    ...
                    <div class="col-8 col-lg-3 dash-event-right">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <h6>Edit Link 1</h6>
                                <div class="form-label-group"><input value="<?php echo $h->link1 ?>" type="text" name="link1" class="form-control" placeholder="link1" required autofocus><label for="link1">Change Link Event</label></div>
