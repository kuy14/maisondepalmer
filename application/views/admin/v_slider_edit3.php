                ...
                <div class="row justify-content-center dashboard-event">
                    <div class="col-8 col-lg-3 dash-event-left">
                        <div class="row justify-content-lg-center h-100">
                            <div class="col-xs-12 col-lg-12 align-self-center">
                                ...
                                <img src="<?php echo base_url("assets/img/" . $h->gambar3) ?>" alt="" width="100%">
                            </div>
                    ...
                    <div class="col-8 col-lg-3 dash-event-right">
                        <div class="row">
                            <div class="col-lg-12">
                                <h6>Edit Event 3</h6>
                                <div class="form-label-group"><input value="<?php echo $h->title3 ?>" type="text" name="title3" class="form-control" placeholder="title3" required autofocus><label for="title3">Change Title Event</label></div>
                                <label for="file-upload" style="font-size:0.8em;">Upload Slider 3 Image</label>
                                <input type="file" name="gbr3" id="input-file-now" class="dropify" data-allowed-file-extensions="jpg png jpeg" data-max-file-size="10M" data-height="60">
                                ...
                                <input type="hidden" name="gambars3" value="<?php echo $h->gambar3; ?>">
                                <input type="submit" name="save3" value="Save Event 3" class="btn btn-success">
                            </div>
