                ...
                <div class="row justify-content-center dashboard-event">
                    <div class="col-8 col-lg-3 dash-event-left">
                        <div class="row justify-content-lg-center h-100">
                            <div class="col-xs-12 col-lg-12 align-self-center">
                                ...
                                <img src="<?php echo base_url("assets/img/" . $h->gambar2) ?>" alt="" width="100%">
                            </div>
                    ...
                    <div class="col-8 col-lg-3 dash-event-right">
                        <div class="row">
                            <div class="col-lg-12">
                                <h6>Edit Event 2</h6>
                                <div class="form-label-group"><input value="<?php echo $h->title2 ?>" type="text" name="title2" class="form-control" placeholder="title2" required autofocus><label for="title2">Change Title Event</label></div>
                                <label for="file-upload" style="font-size:0.8em;">Upload Slider 2 Image</label>
                                <input type="file" name="gbr2" id="input-file-now" class="dropify" data-allowed-file-extensions="jpg png jpeg" data-max-file-size="10M" data-height="60">
                                ...
                                <input type="hidden" name="gambars2" value="<?php echo $h->gambar2; ?>">
                                <input type="submit" name="save2" value="Save Event 2" class="btn btn-success">
                            </div>
