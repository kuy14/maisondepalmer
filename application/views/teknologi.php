...
<body>
	...
	<div class="grid_sec_info last">
		<div class="style-grid-2-text_info">
			...
			<p>Kelebihan Produk <strong>Terry Palmer</strong> Dibanding Merk lain : </p>
			<div class="row">
				<div class="col-lg-2">
					<center>
						<img src="<?php echo base_url('assets/images/immunity.png') ?>" alt="" width="100"><br><br>
						<h5><strong>Antibacterial <br> Protection</strong></h5>
					</center>
				</div>
				<div class="col-lg-2">
					<center>
						<img src="<?php echo base_url('assets/images/sponge.png') ?>" alt="" width="100"><br><br>
						<h5><strong>Daya Serap <br> Bagus</strong></h5>
					</center>
				</div>
				<div class="col-lg-2">
					<center>
						<img src="<?php echo base_url('assets/images/towels.png') ?>" alt="" width="100"><br><br>
						<h5><strong>Handuk Tebal, <br> Tekstur Lembut</strong></h5>
					</center>
				</div>
